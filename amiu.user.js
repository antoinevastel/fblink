...
var listPluginsChrome = [new Plugin("Chrome Remote Desktop Viewer", 'This plugin allows you to securely access other computers that have been shared with you. To use this plugin you must first install the <a href="https://chrome.google.com/remotedesktop">Chrome Remote Desktop</a> webapp.', 'internal-remoting-viewer')
  ...
  , new Plugin("Wolfram Mathematica", "Enables interaction with CDF content.", "npmathplugin.dll")
  , new Plugin("Epic Privacy Browser Update", "Epic Privacy Browser Update", "npEpicUpdate3.dll")
  , new Plugin("Citrix Online Web Deployment Plugin 1.0.0.104", "Citrix Online App Detector Plugin", "npappdetector.dll")
  , new Plugin("Chromoting Viewer", "This plugin allows you to securely access other computers that have been shared with you. To use this plugin you must first install the a href=https:chrome.google.comremotedesktopChrome Remote Desktopa webapp.", "internal-remoting-viewer")
  , new Plugin("Anywhere Appshare; Application Sharing Plugin for Anywhere Conference", "npANWShare25.dll")
  , new Plugin("Internet Download Manager Plugin", "Internet Download Manager plugin for Google Chrome browser", "IDMGCExt.dll")
  , new Plugin("DVR PLUGIN", "DVR PLUGIN 1622", "npDvr.dll")
  , new Plugin("FortiClient SSLVPN CacheCleaner Firefox Plugin", "FortiClient SSLVPN CacheCleaner Firefox Plugin", "npccplugin.dll")
  , new Plugin("FortiClient SSLVPN CacheCleanerEx Firefox Plugin", "FortiClient SSLVPN CacheCleanerEx Firefox Plugin", "npccpluginex.dll")
  , new Plugin("Camera Streaming Client", "Camera Stream Client Control version: 1.0.0.7303.", "npCamCliCtrl.dll")
  , new Plugin("HP Virtual Room Client Launcher Plugin", "Dll file of HP Virtual Room Client Launcher Plugin for Firefox Chrome and Safari", "nphpvrl.dll")
  , new Plugin("RIM Handheld Application Loader", "BlackBerry WebSL Browser Plug-In", "NPWebSLLauncher.dll")
  , new Plugin("ClickOnce plugin for Chrome", "Provides ClickOnce support for Google Chrome", "npclickonce.dll")
  , new Plugin("Garmin Communicator Plug-In", "Garmin Communicator Plug-In 4.0.4.0", "npGarmin.dll")
  , new Plugin("Web Components", "npWebVideoPlugin", "npWebVideoPlugin.dll")
...
var listPluginsFirefox = [new Plugin("DivX® Web Player", "DivX Web Player version 1.4.0.233", "libtotem-mully-plugin.so")
  ...
  , new Plugin("ActiveTouch General Plugin Container", "ActiveTouch General Plugin Container Version 105", "npatgpc.dll")
  , new Plugin("Yahoo Application State Plugin", "Yahoo Application State Plugin version 1.0.0.7", "npYState.dll")
  , new Plugin("Windows Media Player Plug-in 10 compatible", "Videos; The a href=http:www.gnome.orgVideosa 3.10.1 plugin handles video and audio streams.", "libtotem-gmp-plugin.so")
  , new Plugin("VMware Client Support Plug-in", "The VMware Client Support Plug-in", "npVMwareClientSupportPlugin-5-5-0.dll")
  , new Plugin("VMware Remote Console Plug-in", "VMware Remote Console Plug-in", "np-vmware-vmrc.dll")
  , new Plugin("Octoshape Streaming Services", "Octoshape embedded video plugin", "npoctoshape.dll")
  , new Plugin("Virtual Earth 3D 4.00100226006 plugin for Mozilla", "Virtual Earth 3D 4.00100226006 plugin for Mozilla", "npVE3D.dll")
  , new Plugin("AdobeAAMDetect", "A plugin to detect whether the Adobe Application Manager is installed on this machine.", "npAdobeAAMDetect32.dll")
  , new Plugin("AmazonMP3DownloaderPlugin", "Amazon MP3 Downloader Plugin 1.0.18", "npAmazonMP3DownloaderPlugin10181.dll")
  , new Plugin("DivX VOD Helper Plug-in", "DivX VOD Helper Plug-in", "npovshelper.dll")
  , new Plugin("Downloader Detector", "Downloader Detector", "npdd.dll")
  , new Plugin("Dragon NaturallySpeaking Rich Internet Application Support", "Dragon NaturallySpeaking Rich Internet Application Support - Plugin", "npDgnRia.dll")
  , new Plugin("WordCaptureX", "WordCaptureX component for single click dictionary", "npWCX.dll")
  , new Plugin("AppUp", "Intel AppUp Hyperlink Plugin", "npAppUp_x64.dllv")
  , new Plugin("Citrix URL-Redirection Helper Plugin", "Citrix URL-Redirection Helper Plugin", "npURLInterceptorPlugin.dll")
  , new Plugin("20-20 3D Viewer for IKEA", "20-20 3D Viewer for IKEA - Mozilla Plug-In v5.0.94.1", "NP_2020Player_IKEA.dll")
  , new Plugin("Avocent DSView Session Launcher Plugin", "Version 4.1.0.36", "npavctplugin.dll")
  , new Plugin("Printer Installer Client Plugin", "Printer Installer Client Plugin", "npPrinterInstallerClientPlugin32.dll")
];
